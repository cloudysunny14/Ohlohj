 ...
 *
 */
public interface AsyncEnlistMentMethods {
	/**
	 ...
	 */
	public AsyncResponse<EnlistMent> createEnlistMent(long projectId, long enlistMentId) throws OhlohException;
	/**
	 ...
	 * @throws OhlohException when network(Service) is unavailable
	 */
	public AsyncResponse<ResponseList<EnlistMent>> createEnlistMent(long projectId
