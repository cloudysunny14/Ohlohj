 ...
 *
 */
public interface AsyncActivityFactMethods {
	/**
     ...
     */
    public AsyncResponse<ResponseList<ActivityFact>> createActivityFact(long projectId, long analysisId) throws OhlohException;
    /**
     ...
     * @throws OhlohException when network(Service) is unavailable
     */
    public AsyncResponse<ResponseList<ActivityFact>> createActivityFact(long projectId) throws OhlohException;
}
