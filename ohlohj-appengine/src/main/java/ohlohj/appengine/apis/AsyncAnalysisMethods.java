 ...
 *
 */
public interface AsyncAnalysisMethods {
	/**
	 ...
	 */
	public AsyncResponse<Analysis> createAnalysis(long projectId, long analysisId) throws OhlohException;
	 ...
	 * @throws OhlohException when network(Service) is unavailable
	 */
	public AsyncResponse<Analysis> createAnalysis(long projectId) throws OhlohException;
}
