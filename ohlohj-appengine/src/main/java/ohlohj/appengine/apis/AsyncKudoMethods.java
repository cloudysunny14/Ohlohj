 ...
 *
 */
public interface AsyncKudoMethods {
	/**
	 ...
	 */
	public AsyncResponse<ResponseList<Kudo>> createKudoSent(long accountId) throws OhlohException;
	 ...
	 * @throws OhlohException when network(Service) is unavailable
	 */
	public AsyncResponse<ResponseList<Kudo>> createKudo(long accountId) throws OhlohException;
}
