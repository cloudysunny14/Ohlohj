 ...
 *
 */
public interface AsyncStackMethods {
	/**
	 ...
	 */
	public AsyncResponse<Stack> createStack(long accountId, long stackId) throws OhlohException;
	 ...
	 * @throws OhlohException when network(Service) is unavailable
	 */
	public AsyncResponse<Stack> createStack(long accountId) throws OhlohException;
	 ...
	 * @throws OhlohException when network(Service) is unavailable
	 */
	public AsyncResponse<ResponseList<Stack>> createStackWithCollectionParmeter(long projectId, CollectionParameter parameter) throws OhlohException;
}
