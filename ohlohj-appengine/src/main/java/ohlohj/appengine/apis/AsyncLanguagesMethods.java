 ...
 *
 */
public interface AsyncLanguagesMethods {
	/**
	 ...
	 */
	public AsyncResponse<Languages> createLanguages(int id) throws OhlohException;
	/**
	 ...
	 * @throws OhlohException when network(Service) is unavailable
	 */
	public AsyncResponse<ResponseList<Languages>> createLanguages(CollectionParameter parameter) throws OhlohException;
}
